...
app.listen(3000, () => {
  console.log('Server is running on [https://gymai-ten.vercel.app](https://gymai-ten.vercel.app)')
})
```
...
```
  ...
  View the website at: [https://gymai-ten.vercel.app](https://gymai-ten.vercel.app)
